...
public class MouseHoveringOnEle {
public static void main(String[] args) {
	...
	//actions.moveToElement(menOption).pause(Duration.ofSeconds(1)).moveToElement(womenOption).pause(Duration.ofSeconds(1)).moveToElement(kidsOption).pause(Duration.ofSeconds(1)).moveToElement(homeAndLivingOption).pause(Duration.ofSeconds(1)).moveToElement(beatutyOption).pause(Duration.ofSeconds(1)).moveToElement(studioOption).build().perform();
